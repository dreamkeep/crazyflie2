...
static int txpower = RADIO_TXPOWER_TXPOWER_Pos4dBm;//RADIO_TXPOWER_TXPOWER_0dBm;
...
void esbInit()
{
  ...
  NRF_RADIO->FREQUENCY = 0UL;//channel;
...
*/
	...
	NRF_RADIO->PREFIX0 =(0x23<<24)
	                   |(0xC3<<16)
	                   |(0x43<< 8)
	                   |(0xE7<< 0);

	NRF_RADIO->PREFIX1 =(0x13<<24)
	                   |(0xE3<<16)
	                   |(0x63<< 8)
	                   |(0xA3<< 0);
 
  NRF_RADIO->BASE0   = (0xE7<<24)
                      |(0xE7<<16)
	                    |(0xE7<<8)
	                    |(0xE7<<0);

  NRF_RADIO->BASE1   = (0x43<<24)
                      |(0x43<<16)
	                    |(0x43<<8)
	                    |(0x43<<0);
  ...
  NRF_RADIO->PCNF0 = (0<<16)|
                     (0<<8) |
                     (0<<0); 

   NRF_RADIO->PCNF1 = (0<<25)| 
                      (1<<24)| 
                      (4<<16)| 
                      (32<<8)| 
                      (32<<0);  
